...
**প্রাসঙ্গিক প্রশ্ন:** (স্থান/মানসিক অনুভূতি/পজেটিভ-নেগেটিভ এর মধ্যে যা অনুপস্থিত, ঠিক সেটা নিয়ে ১-২টি নির্দিষ্ট প্রশ্ন; সব তথ্য থাকলে সাধারণ একটা এনগেজিং প্রশ্ন)
        ...
        try {
            ...
            const groqRes = await fetch('https://api.groq.com/openai/v1/chat/completions', {
                ...
                body: JSON.stringify({
                    ...
                    max_tokens: 1800 // বিস্তারিত prompt ফিরিয়ে আনার কারণে output-এর জন্য কিছুটা বেশি জায়গা রাখা হলো
                }),
