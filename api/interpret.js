...
export default async function handler(req, res) {
    ...
    // "প্রাসঙ্গিক প্রশ্ন" কী নিয়ে হবে তা কোডেই নির্ধারণ করে দেওয়া হচ্ছে — LLM-এর স্বাধীন সিদ্ধান্তের ওপর রাখা হচ্ছে না
    let contextDirective;
    if (contextQuestionAlreadyAsked) {
        contextDirective = '\n[নির্দেশ: এই কথোপকথনে আগেই একবার প্রাসঙ্গিক প্রশ্ন করা হয়েছে। এবার আর কোনো নতুন তথ্য-সংগ্রহের প্রশ্ন করবেন না — "প্রাসঙ্গিক প্রশ্ন" অংশে শুধু একটা ছোট, সাধারণ কথোপকথনমূলক প্রশ্ন দিন (জীবন-উপদেশ/প্রয়োগ-সংক্রান্ত প্রশ্ন নয়)। গুরুত্বপূর্ণ: এই উত্তরেও অবশ্যই সম্পূর্ণ কাঠামো ব্যবহার করুন — **স্বপ্নের মূল বার্তা:**, **প্রতীক ও ব্যাখ্যা:** (বুলেটসহ), **বাস্তব জীবনের সংযোগ ও করণীয়:**, **প্রাসঙ্গিক প্রশ্ন:** — এই চারটা অংশই থাকতে হবে, ছোট এক-প্যারাগ্রাফের সংক্ষিপ্ত উত্তর দেবেন না।]';
    } else {
        const missing = detectMissingContext(dreamTrimmed);
        contextDirective = missing.length > 0
            ? `\n[নির্দেশ: এই স্বপ্নের বর্ণনায় নিচের তথ্য অনুপস্থিত: ${missing.join(' এবং ')}। "প্রাসঙ্গিক প্রশ্ন" অংশে এই অনুপস্থিত তথ্যটি (গুলো) নিয়েই সরাসরি, নির্দিষ্ট প্রশ্ন করুন। অন্য কোনো ধরনের প্রশ্ন (জীবন-উপদেশ, "কিভাবে প্রয়োগ করবেন", "কী লক্ষ্য আছে" ইত্যাদি) করবেন না।]`
            : '\n[নির্দেশ: এই স্বপ্নের বর্ণনায় স্থান ও অনুভূতি উভয়ই উল্লেখ আছে। তাই "প্রাসঙ্গিক প্রশ্ন" অংশে কোনো তথ্য-সংগ্রহ প্রশ্ন করবেন না, শুধু একটা ছোট, সাধারণ কথোপকথনমূলক প্রশ্ন দিন (জীবন-উপদেশ প্রশ্ন নয়)।]';
    }

    const userContent = contextBlock
        ? `${contextBlock}\nইউজারের স্বপ্ন: "${dreamTrimmed}"${contextDirective}`
