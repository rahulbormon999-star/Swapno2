...
export default async function handler(req, res) {
    ...
    // পরিবেশ ভেরিয়েবলের নাম পরিবর্তন করে Gemini এর জন্য সেট করা হলো
    const KEYS = [
    ...
    for (let i = 0; i < keys.length; i++) {
        try {
            ...
            // Google Gemini OpenAI-compatible এন্ডপয়েন্ট ব্যবহার করা হলো
            const geminiRes = await fetch('https://generativelanguage.googleapis.com/v1beta/openai/chat/completions', {
                ...
                body: JSON.stringify({
                    model: 'gemini-2.0-flash', // Gemini 2.0 Flash মডেল
                    messages,
                    temperature: 0.8,
                    max_tokens: 2000
                }),
